        ...
        <div className="bg-gray-900/80 backdrop-blur-xl p-8 rounded-lg border border-gray-800/50 shadow-2xl">
          <form className="space-y-8">
            ...
            <Button
              ...
              disabled={passwordsDoNotMatch || !password || !confirmPassword}
            >
              Create Account
            </Button>
          </form>
          ...
          <div className="mt-6">
            ...
            <Button
              variant="outline"
              className="w-full mt-4 bg-gray-800 border-gray-700 text-white hover:bg-gray-750 hover:border-gray-600 transition-colors"
            >
